...
odoo.define('pos_payment_terminal.pos_payment_terminal', function (require) {
    ...
    devices.ProxyDevice.include({
        ...
        get_data_send: function(order, line, currency_iso, decimals) {
            var data = {
        ...
        payment_terminal_transaction_start: function(screen, currency_iso, decimals){
            var self = this;
            var order = this.pos.get_order();
            var line = order.selected_paymentline;
            var data = self.get_data_send(order, line, currency_iso, decimals);
            if (this.wait_terminal_answer()) {
                ...
                this.message(
                    ...
                    console.log("payment_terminal_answer", answer);   
                });
            }
        },
    });
